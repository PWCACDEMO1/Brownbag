	...
	function loadChanges() {
		...
		function prepareChanges() {
			...
			if (usePreviewConnector()) {
				...
				oChanges = {
					changes: oResult,
					componentClassName: "ZFI_0262_DEF_REV.zfi_0262_def_renu"
				};
			}
		...
		return new Promise(function (resolve, reject) {
			$.ajax({
				...
				function isMTAChange(sPath) {
					...
					return sPath.startsWith("ZFI_0262_DEF_RENU") && sPath.indexOf("webapp/changes/") > 0 && isValidChangeFileExt(sPath);
				}
